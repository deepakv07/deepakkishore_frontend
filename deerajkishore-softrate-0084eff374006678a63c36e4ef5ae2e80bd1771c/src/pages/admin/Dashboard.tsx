            ...
            <div className="animate-fade-in space-y-12">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8">
                    <div>
                        ...
                        <p className="text-gray-500 mt-4 text-sm font-bold uppercase tracking-widest uppercase">Welcome back, Administrator</p>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {stats.map((stat) => (
                        <div key={stat.label} className="glass-card p-8 border border-white/5 shadow-2xl relative overflow-hidden group hover:border-[#FFD70033] transition-all duration-500">
                            ...
                            <div className="relative z-10">
                                <div className="w-12 h-12 bg-white/5 text-gray-400 rounded-xl flex items-center justify-center mb-6 text-lg border border-white/5 group-hover:bg-[#FFD70011] group-hover:text-[#FFD700] group-hover:border-[#FFD70022] transition-all duration-500 shadow-lg">
                ...
                {/* Recent Quizzes Feed */}
                <div className="glass-card rounded-[2.5rem] border border-white/5 shadow-2xl relative overflow-hidden">
                    <div className="p-10 border-b border-white/5 flex flex-col md:flex-row justify-between items-center gap-6 bg-white/1">
                        <div className="flex items-center gap-4">
                            <div className="w-10 h-10 bg-[#FFD70011] text-[#FFD700] rounded-2xl flex items-center justify-center border border-[#FFD70022]">
                                <i className="fas fa-list"></i>
                            </div>
                            <div>
                                <h2 className="text-xl font-black text-white uppercase tracking-tighter">Recent Quizzes</h2>
                                <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Manage your submitted quizzes</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-3">
                            <button className="px-5 py-2.5 rounded-xl bg-white/5 border border-white/10 text-[10px] font-black text-gray-400 uppercase tracking-widest hover:text-white hover:border-white/20 transition-all">Filter</button>
                            <button className="px-5 py-2.5 rounded-xl bg-white/5 border border-white/10 text-[10px] font-black text-gray-400 uppercase tracking-widest hover:text-white hover:border-white/20 transition-all">Export</button>
                        </div>
                    </div>
                        ...
                        {quizzesLoading ? (
                            ...
                            <div className="text-center py-24 relative overflow-hidden group">
                                ...
                                <div className="relative z-10 flex flex-col items-center">
                                    <div className="w-20 h-20 bg-white/2 rounded-full flex items-center justify-center mb-6 border border-white/5 text-gray-600 group-hover:text-[#FFD700] group-hover:border-[#FFD70022] transition-all duration-700">
                                        ...
                                        {quizzes.slice(0, 10).map((quiz) => (
                                            <tr key={quiz.id} className="group hover:bg-[#FFD70008] transition-all duration-300">
                                                <td className="px-6 py-8 rounded-l-[1.5rem] border-y border-l border-white/5 group-hover:border-[#FFD70011]">
                                                    <div className="font-black text-white text-base tracking-tight uppercase group-hover:text-[#FFD700] transition-colors">{quiz.title}</div>
                                                    {quiz.description && (
                                                ...
                                                <td className="px-6 py-8 border-y border-white/5 group-hover:border-[#FFD70011]">
                                                    <span className="text-[10px] font-black text-gray-500 uppercase tracking-[0.2em] bg-white/2 px-3 py-1.5 rounded-lg border border-white/5 group-hover:border-[#FFD70011] group-hover:text-gray-300">
                                                ...
                                                <td className="px-6 py-8 text-center border-y border-white/5 group-hover:border-[#FFD70011]">
                                                    <div className="flex flex-col items-center gap-1">
                                                        <span className="text-sm font-black text-white tabular-nums">{quiz.totalQuestions}</span>
                                                    </div>
                                                </td>
                                                <td className="px-6 py-8 text-center border-y border-white/5 group-hover:border-[#FFD70011]">
                                                    <div className="flex items-center justify-center gap-2">
                                                        <div className="w-1.5 h-1.5 rounded-full bg-[#00FF41] shadow-[0_0_8px_#00FF41]"></div>
                                                        <span className="text-sm font-black text-white tabular-nums">{quiz.totalSubmissions || 0}</span>
                                                    </div>
                                                </td>
                                                <td className="px-6 py-8 text-center border-y border-white/5 group-hover:border-[#FFD70011]">
