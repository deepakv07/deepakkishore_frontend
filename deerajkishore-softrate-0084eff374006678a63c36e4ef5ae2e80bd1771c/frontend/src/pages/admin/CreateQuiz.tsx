                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full px-4 py-4 bg-white/2 border border-white/10 rounded-xl focus:border-[#FFD70044] focus:ring-1 focus:ring-[#FFD70022] outline-none text-white text-xs font-bold transition-all [color-scheme:dark]"
                                        />
                                    </div>
                                    <div>
                                        <label className="block text-[10px] font-black text-gray-500 uppercase tracking-widest mb-3 ml-1">End Date</label>
                                        <input
                                            type="datetime-local"
                                            value={endDate}
